...
class S {
  ...
  /// `Article`
  String get phoneNumberAlreadyRegister {
    return Intl.message(
      'Phone number is already in use. Please try different phone number.',
      name: 'phoneNumberAlreadyRegister',
      desc: '',
      args: [],
    );
  }
  ...
  String get writeHereAnyAdditionalInfo {
    return Intl.message(
      'Write here any additional info',
      name: 'writeHereAnyAdditionalInfo',
      desc: 'Write here any additional info',
      args: [],
    );
  }
