...
class _EcommerceCheckoutLayoutState
  ...
  Widget build(BuildContext context) {
    ...
    Stripe.publishableKey =
        'pk_test_51RISFD000TiqKmsovQhaaedh1bSkfYuTdBZCTkq9yPxISXnfNeaIqbi2lCehG3Tff2UsaRqjyNjOllRjb4qoJG6E00dJuqWGAo';
  ...
  Widget _buildAddAddressCardWidget() {
    return Container(
      ...
      child: Row(
        children: [
          SvgPicture.asset(Assets.svg.locationPurple, width: 20.w),
          Gap(10.w),
          Expanded(
  ...
  Widget _buildAdditionalInfoTextField() {
    return FormBuilderTextField(
      ...
      style: AppTextStyle(
        context,
      ).bodyText.copyWith(fontWeight: FontWeight.w600),
                  ...
                  onPressed: () {
                    if (ref.watch(selectedDeliveryAddress) == null) {
                      ...
                      if (selectedPaymentType == PaymentType.cash) {
                        ...
                        var payableamt =
                            ref.read(cartSummeryController)['payableAmount'] *
                            100;

                        makeStripePayment(payableamt.toStringAsFixed(0), 'RON');

                        debugPrint(
                          'selectedPaymentType online: $selectedPaymentType',
                        );
                      } else {
                        if (pdfFilePath == null) {
                          GlobalFunction.showCustomSnackbar(
                        ...
                        debugPrint('selectedPaymentType else:');
                        _placeOrder();
                      }
                    }
                  },
